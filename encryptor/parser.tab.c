...
{
  "\"end of file\"", "error", "\"invalid token\"", "PASSWORD", "$accept",
...
#line 38 "parser.y"
             {
                ...
                encrypt(key, iv, (unsigned char*)(yyvsp[0].str), ciphertext);
                ...
                printf("\n");
                free((yyvsp[0].str));  /* Libera la memoria asignada para el texto plano */
             }
